...
- `RecordCreatedIntegrationEvent`: recordsetId, recordId, createdBy, createdAt. Consumers: Notifications (item created
  rules).
...
- `RecordDeletedIntegrationEvent`: recordsetId, recordId, deletedBy, deletedAt. Consumers: Notifications (item deleted
  rules).

## Clocks

- `ClockAtRiskIntegrationEvent`: clockId, tenantId, recordsetId, recordId, definitionId, clockName, atRiskAt,
  breachDueAt.
  Consumers: Notifications (clock at-risk rules).
- `ClockBreachedIntegrationEvent`: clockId, tenantId, recordsetId, recordId, definitionId, clockName, breachedAt,
  breachDueAt.
